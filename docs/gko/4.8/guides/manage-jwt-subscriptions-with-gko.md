...
5.  Configure the subscription resource. For a subscription to be valid, it must reference the following:
    ...
    <div data-gb-custom-block data-tag="hint" data-style="warning" class="hint hint-warning"><p>If your API reference points to a v2 API, you must add the <code>kind</code> property with the <code>ApiDefinition</code> value to your API reference.</p></div>
