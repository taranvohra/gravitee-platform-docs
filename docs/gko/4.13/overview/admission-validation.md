---
description: >-
  The Gravitee Kubernetes Operator admission webhook sends a dry-run call to the
  APIM Automation API before a custom resource is stored. See what it checks.
---
