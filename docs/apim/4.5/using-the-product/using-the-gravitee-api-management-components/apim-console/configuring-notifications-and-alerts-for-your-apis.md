...
Gravitee allows you to set up alerts and notifications based on events recognized by the Gateway. You can [set up notifications](configuring-notifications-and-alerts-for-your-apis.md#configure-notifications-for-your-apis) that appear in the Gravitee API Management Console or that are sent to Gravitee users via email. You can also [create custom alerts](configuring-notifications-and-alerts-for-your-apis.md#configure-alerts) based on user-defined rules and conditions.
...
The [templates](configuring-notifications-and-alerts-for-your-apis.md#templates) of email notifications can be customized in **Settings.**
{% endtab %}
...
<div><figure><img src="../../../.gitbook/assets/override_default_off.png" alt=""><figcaption></figcaption></figure> <figure><img src="../../../.gitbook/assets/override_default_on.png" alt=""><figcaption></figcaption></figure></div>
