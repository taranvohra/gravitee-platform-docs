...
Your API must have at least one Security/Consumer [Plan](../../secure-and-expose-apis/plans/) associated with it before it can be deployed to a Gateway. For more information about Plans, see [https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/apim/4.9/how-to-guides/use-case-tutorials/broken-reference/README.md](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/apim/4.9/how-to-guides/use-case-tutorials/broken-reference/README.md "mention"). The following procedure explains how to create a `KEYLESS` plan.
