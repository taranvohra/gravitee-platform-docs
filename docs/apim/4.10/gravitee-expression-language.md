...
To avoid errors caused by duplicate keys, apply the JSON threat protection policy to the API. For more information about the JSON threat protection policy, see [https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/apim/4.10/create-and-configure-apis/apply-policies/policy-reference/json-threat-protection/README.md](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/apim/4.10/create-and-configure-apis/apply-policies/policy-reference/json-threat-protection/README.md "mention").
{% endhint %}
