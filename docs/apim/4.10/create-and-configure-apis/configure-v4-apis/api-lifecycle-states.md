...
{% hint style="info" %}
The Console doesn't expose an **Archive** action. To set the ARCHIVED state, use the Management API or the [Gravitee Kubernetes Operator](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/gko/4.10/guides/publish-apis-to-the-portal.md).
{% endhint %}
