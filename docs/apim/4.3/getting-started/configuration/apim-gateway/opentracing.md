...
1.  Use the Docker run command for installing Jaeger with no customizations:
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>Running this Docker command will also provide access to the JaegerUI, which can be reached on its default port: <code>http://localhost:16686</code></p></div>
