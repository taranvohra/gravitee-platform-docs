...
3.  Select **Policies** from the inner left nav
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p><strong>Flows vs. policies</strong></p><p>Flows are a collection of policies. Flows can be specified for each individual plan, e.g., API Key (SILVER), API Key (GOLD), and API Key (PLATINUM). Alternatively, a common flow can be applied to all plans within the specific API.</p></div>
...
6.  Enter values for **Max requests (static)**_,_ **Time duration**, and **Time unit**, e.g., 5 requests per 1 second
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>The Rate Limit time period is shorter than the Quota time period.</p></div>
7. Click **Add policy**
...
2.  At step 4, click **Add plan**
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>All created APIs will include a <strong>Default Keyless (UNSECURED)</strong> plan. You may modify or delete this plan.</p></div>
...
6.  Click **Next** to add Quota and/or Rate Limit policies
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>The Spike Arrest policy cannot be added during the API creation process.</p></div>
...
7.  Toggle Rate Limiting and/or Quota ON to configure rate limiting policies for the plan
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>Rate limiting policies added during the API creation process will applied to the request phase.</p></div>
