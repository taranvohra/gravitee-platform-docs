---
description: Configuration guide for applications.
---
...
{% hint style="warning" %}
Dynamic Client Registration is an [Enterprise Edition](../overview/enterprise-edition.md) capability
{% endhint %}
