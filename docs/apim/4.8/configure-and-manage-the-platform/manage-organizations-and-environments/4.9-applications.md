...
* Use the **Initial Access Token Provider** drop-down menu to select the [initial access token flow](4.9-applications.md#initial-access-token-flows):
...
* **Trust Store Type:** Use the drop-down menu to specify trusted SSL/TLS certificates. See [#dcr-trusted-certificate-configuration-details](4.9-applications.md#dcr-trusted-certificate-configuration-details "mention") for more information.
* **Key Store Type:** Use the drop-down menu to configure a key store. See [#dcr-trusted-certificate-configuration-details](4.9-applications.md#dcr-trusted-certificate-configuration-details "mention") for more information.
...
* [Authorization code](4.9-applications.md#authorization-code)
* [Implicit](4.9-applications.md#implicit)
* [Resource owner credentials](4.9-applications.md#resource-owner-credentials)
* [Client credentials](4.9-applications.md#client-credentials)
* [Refresh token](4.9-applications.md#refresh-token)
