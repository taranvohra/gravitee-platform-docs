...
**Closed:** Once a plan is closed, all associated subscriptions are closed. This cannot be undone. API consumers subscribed to this plan won’t be able to use your API.
