...
Starting with version 4.4.11, there is a new permission called USER\_TOKEN. This permission controls which users have the ability to read, create, update, and delete user tokens.
