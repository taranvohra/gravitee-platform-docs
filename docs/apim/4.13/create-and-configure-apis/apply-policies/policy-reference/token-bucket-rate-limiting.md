...
| [Flush Interval](token-bucket-rate-limiting.md#rate-limit-service) | Long (ms) | `5000`  | Global interval at which async (non-strict) local counters/buckets are reconciled to the store |
