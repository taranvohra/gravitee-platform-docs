...
The ability to create APIs with message API entrypoints is an [Enterprise Edition](../../readme/enterprise-edition/) capability. To learn more about Gravitee Enterprise and what's included in various enterprise packages:
...
The ability to create APIs with message API endpoints is an [Enterprise Edition](../../readme/enterprise-edition/) capability. To learn more about Gravitee Enterprise and what's included in various enterprise packages:
