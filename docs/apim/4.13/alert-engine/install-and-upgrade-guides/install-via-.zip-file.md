...
1.  Download the binaries from [here](https://download.gravitee.io/graviteeio-ae/components/gravitee-ae-engine-2.1.2.zip) or using the command line:
    ...
    <pre data-overflow="wrap"><code>$ curl -L https://download.gravitee.io/graviteeio-ae/components/gravitee-ae-engine-2.1.2.zip -o gravitee-ae-standalone-2.1.2.zip
    </code></pre>
