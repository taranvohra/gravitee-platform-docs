---
description: >-
  Configure connection metrics reporting and view Native Kafka API connection
  logs.
---
...
| **Applications**      | Server-paginated search-and-select. | Resolves _Application_ names using the existing _Applications_ endpoint.                                          |
| **Plans**             | _Plan_ picker scoped to this API.   | Lists all _Plans_ on the API.                                                                                     |
...
| **Application**       | Resolved name from `applicationId`. | Renders empty when the _Application_ is deleted or the resolution call fails.                                                                          |
| **Plan**              | Resolved name from `planId`.        | This has the same fallback behavior as _Application_.                                                                                                  |
