...
2. From the \*\* Add a group with roles\*\* pop-up menu, assign the user to a group and one or more roles by completing the following steps: a. From the **Group** dropdown menu, select the group that you want to assign the user to. b. (Optional) Enable the **Group admin role**, which provides the user with admin permissions for that group. c. From the **API Role** dropdown menu, select the role that you want to assign to the user. d. From the **API Product Role** dropdown menu, select the API Product Role for the user. e. From the **Application Role** dropdown menu, select the Application Role for the user. f. From the **Integration Role** dropdown menu, select the Integration Role for the user. g. Click **Save**.
