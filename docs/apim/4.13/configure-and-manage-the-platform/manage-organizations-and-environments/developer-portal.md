...
The Automation API supports programmatic management of portal structure, API listings, and documentation pages for the next-generation Developer Portal. For details, see [Portal automation](../../developer-portal/new-developer-portal/customize-the-navigation/portal-automation/).
