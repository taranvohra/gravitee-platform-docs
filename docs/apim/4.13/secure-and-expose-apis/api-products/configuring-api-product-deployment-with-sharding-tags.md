...
The Deploy action is available to users with the **API\_PRODUCT\_DEFINITION:UPDATE** permission. Verifying deployment (license and compatibility check) requires the **API\_PRODUCT\_DEFINITION:READ** permission.
