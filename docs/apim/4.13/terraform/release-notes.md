...
* **GA support model** for provider **1.0.x** (see [Compatibility & support](release-notes.md#compatibility--support)).
...
* **Stricter HRID validation** and removal of **`metadata.hidden`** (see [Breaking changes & migration](release-notes.md#breaking-changes--migration)).
...
Resource reference: [apim\_apiv4](https://registry.terraform.io/providers/gravitee-io/apim/latest/docs/resources/apiv4)
...
Resource reference: [apim\_application](https://registry.terraform.io/providers/gravitee-io/apim/latest/docs/resources/application)
...
Resource reference: [apim\_shared\_policy\_group](https://registry.terraform.io/providers/gravitee-io/apim/latest/docs/resources/shared_policy_group)
...
Resource reference: [apim\_subscription](https://registry.terraform.io/providers/gravitee-io/apim/latest/docs/resources/subscription)
...
Review [Breaking changes & migration](release-notes.md#breaking-changes--migration) before upgrading production workspaces.
...
| **1.0.x**           | **4.9.x – 4.11.x**                                      | **Compatible** — existing configurations continue to work; **new 1.0 attributes are not managed** (see [New fields](release-notes.md#new-and-changed-fields-by-resource)) | **1.9+** / latest OpenTofu                                                                               |
...
> **Note:** Until the [Terraform documentation page](./) is updated for GA, the preview disclaimer (“tech preview”, “fixes mainly on latest”) applies to **0.x** lines only; **1.0.x** is the supported GA line.
