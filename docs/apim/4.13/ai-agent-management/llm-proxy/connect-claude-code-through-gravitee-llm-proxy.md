---
description: >-
  Configure Claude Code to access Anthropic through a Gravitee LLM Proxy while
  preserving Claude Code OAuth login.
---
...
* Access to Gravitee APIM Console. For more information, see [getting-started](../../getting-started/).
...
1. [Configure the LLM Proxy API](connect-claude-code-through-gravitee-llm-proxy.md#configure-the-llm-proxy-api)
2. [Configure models](connect-claude-code-through-gravitee-llm-proxy.md#configure-models)
3. [Create a plan and subscription](connect-claude-code-through-gravitee-llm-proxy.md#create-a-plan-and-subscription)
4. [Configure Claude Code](connect-claude-code-through-gravitee-llm-proxy.md#configure-claude-code)
