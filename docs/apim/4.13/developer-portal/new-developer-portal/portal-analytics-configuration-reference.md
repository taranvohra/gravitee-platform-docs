...
* An administrator has enabled analytics for the New Developer Portal (see [Enable analytics in the Console](portal-analytics-configuration-reference.md#enable-analytics-in-the-console)).
