---
description: >-
  Group the APIs in your New Developer Portal catalog into categories in the
  APIM Console. Follow the steps to create one and assign APIs to it.
---
...
* Add the APIs you want to categorize to the portal navigation and publish them. For more information, see [#customizing-your-navigation](customize-the-navigation/#customizing-your-navigation "mention").
