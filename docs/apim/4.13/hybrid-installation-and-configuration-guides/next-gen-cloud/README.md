...
{% hint style="info" %}
Your Gateway needs to connect to the Cloud Gate in the region where your Control Plane is deployed. The traffic is routed over HTTPS/443.
{% endhint %}

The following table lists the Cloud Gate URL for each Control Plane geography:

<table><thead><tr><th width="300">Control Plane geography</th><th>Cloud Gate URL</th></tr></thead><tbody><tr><td>Australia</td><td><code>https://au.cloudgate.gravitee.io/</code></td></tr><tr><td>Europe</td><td><code>https://eu.cloudgate.gravitee.io/</code></td></tr><tr><td>Switzerland</td><td><code>https://ch.cloudgate.gravitee.io/</code></td></tr><tr><td>United Arab Emirates</td><td><code>https://uae.cloudgate.gravitee.io/</code></td></tr><tr><td>United States</td><td><code>https://us.cloudgate.gravitee.io/</code></td></tr></tbody></table>
...
{% hint style="info" %}
To keep analytics while sending them somewhere you control, configure another reporter instead of, or alongside, this setting. See [reporters](../../analyze-and-monitor-apis/reporters/).
{% endhint %}

Setting `cloud.enabled` to `false` is a different action. That severs the whole Cloud Gate connection, so the Gateway stops receiving configuration as well. See [configure Cloud Gateway client](../configure-cloud-gateway-client.md).
