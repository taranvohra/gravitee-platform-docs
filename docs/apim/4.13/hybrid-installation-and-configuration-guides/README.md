...
<figure><img src="../.gitbook/assets/hybrid-component-management.png" alt=""><figcaption></figcaption></figure>
...
To route the Gateway-to-bridge connection through a corporate proxy, see [Hybrid Gateway Proxy Configuration](hybrid-gateway-proxy-configuration.md).
