...
* Declarative portal management via Gravitee Kubernetes Operator (GKO) CRDs for portal structure, API listings, and documentation. See [Portal automation](new-developer-portal/customize-the-navigation/portal-automation/) for details.
