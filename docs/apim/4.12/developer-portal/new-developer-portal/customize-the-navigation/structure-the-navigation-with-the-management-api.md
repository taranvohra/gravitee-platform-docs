...
For full details, see the [Portal automation](portal-automation/) documentation, which covers portal instances, listings, portal-scoped documentation, and API-scoped documentation.
