...
Dampenings are a good way to reduce the frequency of your notifications. See the [Dampening](../dampening.md) page for more information about various dampening strategies you can use.

### **Time-based conditions**

[Aggregation](../alerts-and-conditions.md#aggregation) and [Rate](../alerts-and-conditions.md#rate) conditions rely on `duration` and `timeUnit`, so they can be evaluated in a given period of time.
