---
description: >-
  A tutorial guide about manage organizations & environments in Gravitee's
  platform.
metaLinks:
  alternates:
    - ./
...
{% hint style="info" %}
CORS can also be configured at the API level. For more information, see the [v2 API](../../create-and-configure-apis/configure-v2-apis/proxy-settings.md) and [v4 API ](../../create-and-configure-apis/configure-v4-apis/cors.md)CORS documentation.
{% endhint %}
{% endtab %}
...
As a part of Organization administration, Gravitee offers multiple ways to manage and control access to the [Gravitee platform](https://www.gravitee.io/platform) via identity provider configuration and login/registration settings. See the [Authentication](authentication/) documentation for details.
