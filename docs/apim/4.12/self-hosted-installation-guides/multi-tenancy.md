...
{% hint style="warning" %}
Multi-tenancy requires running APIM 4.2 and an [enterprise-enabled Gravitee Cloud account](../readme/enterprise-edition/#enterprise-version-of-gravitee-cockpit).
