...
* Install Gravitee API Management version 4.4 or later, with an enterprise license. For more information about Enterprise edition, see[ Enterprise Edition Licensing.](../../../readme/enterprise-edition/enterprise-edition-licensing.md#license-support)
