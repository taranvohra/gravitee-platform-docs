...
To configure an OAuth2 plan, you must first create an [OAuth2 client resource](../../create-and-configure-apis/apply-policies/resources/) that represents your OAuth 2.0 authorization server.
