...
| Permission                      | Access                                                                                         |
| ------------------------------- | ---------------------------------------------------------------------------------------------- |
| `API_PRODUCT_DEFINITION` READ   | View Configuration and APIs tabs                                                               |
| `API_PRODUCT_DEFINITION` UPDATE | Edit configuration, assign sharding tags, deploy                                               |
| `API_PRODUCT_PLAN` CREATE       | Create plans, assign sharding tags when creating a plan                                        |
| `API_PRODUCT_PLAN` READ         | View Plans tab                                                                                 |
| `API_PRODUCT_PLAN` UPDATE       | Edit plans, assign sharding tags when editing a plan, publish, deprecate, close, reorder plans |
| `API_PRODUCT_SUBSCRIPTION` READ | View Subscriptions tab                                                                         |
