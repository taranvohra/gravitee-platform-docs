...
{% hint style="warning" %}
The Audit Trail is an [Enterprise Edition](../readme/enterprise-edition/) capability. To learn more about Gravitee EE and what's included in various enterprise packages, please:
