...
* \[Gamma/AIM] LLM Proxy with provider OPEN\_AI\_COMPATIBLE shows no models — LlmRequestFormat enum is narrower than the llm-proxy connector's [#11677](https://github.com/gravitee-io/issues/issues/11677)
* No data on Observability dashboards for API\_PUBLISHER [#11651](https://github.com/gravitee-io/issues/issues/11651)
...
* Console Audit screen returns HTTP 500 — missing AUTHORIZATION\_POLICY/AUTHORIZATION\_ENTITY in repository Audit.AuditProperties enum [#11650](https://github.com/gravitee-io/issues/issues/11650)
