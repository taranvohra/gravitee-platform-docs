...
| `headers()`           | Headers object              | HTTP headers (mutable). See [Headers Methods](javascript-policy-new-reference.md#headers-methods). |
...
| `headers()`         | Headers object | HTTP headers (mutable). See [Headers Methods](javascript-policy-new-reference.md#headers-methods).  |
| `trailers()`        | Headers object | HTTP trailers (mutable). See [Headers Methods](javascript-policy-new-reference.md#headers-methods). |
...
| `headers()`                    | Headers object        | Message headers (mutable). See [Headers Methods](javascript-policy-new-reference.md#headers-methods). |
