...
| Reporter   | [Datadog Reporter](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/apim/4.9/analyze-and-monitor-apis/reporters/datadog-reporter.md) | Send Gravitee API metrics directly to your Datadog instance for advanced dashboarding and observability.                                                            |
...
| Entrypoint | [WebSocket](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/apim/4.9/create-and-configure-apis/configure-v4-apis/entrypoints/websocket.md) | Send and retrieve streamed events and messages in real time using the WebSocket protocol.                          |
