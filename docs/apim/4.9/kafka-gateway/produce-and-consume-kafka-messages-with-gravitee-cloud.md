...
1.  Sign in to [Gravitee Cloud](https://cloud.gravitee.io/).
    ...
    <figure><img src="../.gitbook/assets/kafka-gateway-produce-and-consume-kafka-272-1.png" alt=""><figcaption></figcaption></figure>
...
3.  In the **Gravitee Hosted Gateway Details** screen, navigate to the **Gateway Deployment Details** section, and then copy the **Kafka Domain**.
    ...
    <figure><img src="../.gitbook/assets/kafka-gw-produce-and-consume-kafka--305.png" alt=""><figcaption></figcaption></figure>
