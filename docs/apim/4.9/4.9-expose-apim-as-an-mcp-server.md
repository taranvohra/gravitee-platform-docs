...
2.  From the **Dashboard**, click **Organization**.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-333-1.png" alt=""><figcaption></figcaption></figure>
3.  From the **Organization** menu, click **Users**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-334-1.png" alt=""><figcaption></figcaption></figure>
4.  Click **Add user**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-335-1.png" alt=""><figcaption></figcaption></figure>
5.  In the **Pre-register a user** screen, create the service account. To create a service account, complete the following sub-steps:
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-336-1.png" alt=""><figcaption></figcaption></figure>
6.  In the **Users** screen, click the service account that you created.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-338-1.png" alt=""><figcaption></figcaption></figure>
7.  In the **User details** screen, assign the service account permissions. The AI assistant's capabilities are determined by the permissions you set for the service account.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-12-1.png" alt=""><figcaption></figcaption></figure>
8.  In the **You have unsaved changes** pop-up window, click **Save**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-340-1-1.png" alt=""><figcaption></figcaption></figure>
9.  Navigate to the **Tokens** section, and then click **+ Generate a personal token**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-323-1.png" alt=""><figcaption></figcaption></figure>
10. In the **Generate a token** pop-up window, enter a name for your token. For example, mcp-server-token.
11. Click **Generate**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-324-1.png" alt=""><figcaption></figcaption></figure>
