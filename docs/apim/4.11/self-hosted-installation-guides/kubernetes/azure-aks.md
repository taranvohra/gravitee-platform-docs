...
* (Optional) [License key](../../readme/enterprise-edition/enterprise-edition-licensing.md) for Enterprise features
...
Before installing Gravitee APIM for [enterprise edition](../../readme/enterprise-edition/), you need to create a Kubernetes secret for your license key.
