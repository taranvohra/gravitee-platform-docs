...
3. Upgrade the Gateways. Recommended: upgrade Gateways progressively instead of stopping the whole fleet at once. Before you upgrade a hybrid Gateway, confirm that the Gateway and control plane versions are compatible: Classic Cloud deployments follow the [Gateway and Bridge compatibility tables](../hybrid-installation-and-configuration-guides/classic-cloud/#gateway-and-bridge-compatibility-versions), and Next-Gen Cloud hybrid Gateways match the Control Plane version.
4. If you manage APIs with the Gravitee Kubernetes Operator (GKO), upgrade GKO after APIM. Keep your APIM version equal to or newer than your GKO version at every step. For the supported version window, see [GKO Compatibility and Limitations](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/gko/4.12/overview/compatibility-and-limitations.md).
