...
[**Community Edition:**](enterprise-edition/) An API management platform comprising Gravitee’s open-source offerings and the free versions of Gravitee-managed enterprise products.

[**Enterprise Edition:**](enterprise-edition/) The enhanced version of Gravitee's open-source and event-native API management platform. Feature sets targeting commercial end users include Alert Engine, a no-code API Designer with unlimited data models, monetization capabilities, and advanced protocol mediation options.
