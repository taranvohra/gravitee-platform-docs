...
For Kubernetes-managed certificate configuration, see [Kubernetes CRD Configuration for Client Certificates](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/gko/4.11/guides/kubernetes-crd-configuration-for-client-certificates.md).
