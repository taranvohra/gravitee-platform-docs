...
The ability to create APIs with message API endpoints is an [Enterprise Edition](../../../readme/enterprise-edition/) capability. To learn more about Gravitee Enterprise Edition and what's included in various enterprise packages:
