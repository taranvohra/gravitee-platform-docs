...
## Gravitee API Management 4.11.22 - July 22, 2026
...
## Gravitee API Management 4.11.21 - July 21, 2026

{% hint style="warning" %}
There is a known issue with API synchronizations in this version of APIM. Upgrade to version 4.11.22+.
{% endhint %}
...
* Datadog Reporter - Missing nodehost tags [#11537](https://github.com/gravitee-io/issues/issues/11537)
...
* EL Not Evaluated in List Fields by ConfigurationEvaluatorProcessor [#11589](https://github.com/gravitee-io/issues/issues/11589)
...
* ClassCastException in reactive contextual logging when ATTR\_REQUEST\_METHOD is set to HttpMethod by rest-to-soap policy [#11532](https://github.com/gravitee-io/issues/issues/11532)
...
* V2 API duplication with plans fails: plan not copied, "Api \[] cannot be found" [#11535](https://github.com/gravitee-io/issues/issues/11535)
...
* BUG: LLM\_PROXY, Bedrock streaming [#11426](https://github.com/gravitee-io/issues/issues/11426)
...
* JDBC: gateway warmup ApiKey appender Seq-scans key\_subscriptions (missing subscription\_id index) [#11494](https://github.com/gravitee-io/issues/issues/11494)
...
* JDBC repository: support MySQL deployments with sql\_require\_primary\_key=ON [#11401](https://github.com/gravitee-io/issues/issues/11401)
