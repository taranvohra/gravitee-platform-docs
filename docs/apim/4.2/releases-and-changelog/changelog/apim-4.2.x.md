...
* \[gravitee-entrypoint-webhook] Support 500 responses for DLQ : add client\_id and errors stack in the message sent to DLQ [#9740](https://github.com/gravitee-io/issues/issues/9740)
...
* Email related to closed, paused, and resumed subscription of API\_KEY plan are sent with an empty body [#3107](https://github.com/gravitee-io/issues/issues/3107)
