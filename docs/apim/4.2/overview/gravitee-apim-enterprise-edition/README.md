...
Gravitee's platform extends beyond just API Management. For information on enterprise versions of other products, please refer to our [platform overview documentation.](https://documentation.gravitee.io/apim/readme/enterprise-edition)
{% endhint %}
...
* [**Avro <> JSON policy**](../../reference/policy-reference/avro-to-json.md): Transform information in Avro format into JSON format
