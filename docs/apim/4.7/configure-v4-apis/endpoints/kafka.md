...
{% hint style="info" %}
You can also use the Gravitee Kafka Gateway to proxy a Kafka cluster using the Kafka native protocol (over TCP).
{% endhint %}
...
<figure><img src="../../.gitbook/assets/v4-config-endpoints-kafka-137.png" alt=""><figcaption></figcaption></figure>
