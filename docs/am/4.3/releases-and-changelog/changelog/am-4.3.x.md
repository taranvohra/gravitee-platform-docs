...
* Error "ERR\_TOO\_MANY\_REDIRECTS" when hide login form is enabled. [#9898](https://github.com/gravitee-io/issues/issues/9898)
...
* null-1 entry in auth\_flow\_ctx table should not be stored in database [#9803](https://github.com/gravitee-io/issues/issues/9803)
...
* Source IP and user agent missing from FORGOT\_PASSWORD\_REQUESTED audit log [#9724](https://github.com/gravitee-io/issues/issues/9724)
...
### OpenID scope for client\_credentials

The `openid` scope is now forbidden for client\_credentials flow as this not related to user authentication.
