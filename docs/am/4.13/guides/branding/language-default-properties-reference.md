...
| `oauth.consent.scope.select_all`            | `Select all`                                                                                  |
| `oauth.consent.scope.clear_all`             | `Clear all`                                                                                   |
| `oauth.consent.scope.selected_count`        | `{0} of {1} selected`                                                                         |
| `oauth.consent.scope.search_placeholder`    | `Search permissions...`                                                                       |
