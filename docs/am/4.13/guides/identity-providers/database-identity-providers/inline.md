...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/H4VhZJXn1S232OEmh8Wv/guides/identity-providers/database-identity-providers/inline
---
...
You can also create the identity provider with [AM API](../../../reference/am-api-reference/).
