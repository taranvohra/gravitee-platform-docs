...
The endpoints are the same as the endpoints described in the [AM API specification](../../../reference/am-api-reference/). AM provides the following OAuth 2.0 endpoints for the AM Gateway:
