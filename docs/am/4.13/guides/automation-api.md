...
To obtain a token, call the Management API token endpoint with the user's credentials. For details, see [Authorization](../reference/am-api-reference/#authorization).
