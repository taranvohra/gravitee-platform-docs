...
The following examples give guidance on how to use this feature. All the attribute names are based on the user model provided by [AM API.](../../../reference/am-api-reference/)
