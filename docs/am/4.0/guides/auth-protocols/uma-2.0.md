---
description: Overview of User-Managed Access.
---
...
You can use the [Introspection endpoint](https://github.com/gravitee-io/gravitee-platform-docs/tree/main/docs/am/4.0/guides/auth-protocols/oauth-2.0) to inspect the properties of the RPT.
