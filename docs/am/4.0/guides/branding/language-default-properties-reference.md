...
| email.magic\_link.header.title                      | Sign in to {0}.                                                                                                                                            |
| email.magic\_link.header.description.first.row      | Hi there,                                                                                                                                                  |
| email.magic\_link.header.description.second.row     | You requested to sign in to {0}. Click the button below to access your account:                                                                            |
| email.magic\_link.button                            | Sign in to {0}                                                                                                                                             |
| email.magic\_link.expiration                        | This link will expire in {0,number,integer} {1} for security.                                                                                              |
| email.magic\_link.raw.link                          | If the button doesn't work, copy and paste this link into your browser:                                                                                    |
