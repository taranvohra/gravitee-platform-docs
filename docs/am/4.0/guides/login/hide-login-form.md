...
<figure><img src="../../.gitbook/assets/graviteeio-am-userguide-hide-login-form-settings.png" alt=""><figcaption><p>Settings page for an application with Hide Login Form enabled</p></figcaption></figure>
