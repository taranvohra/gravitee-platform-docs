...
<figure><img src="../../.gitbook/assets/guide-identity-providers-user-and-r-2.png" alt=""><figcaption><p>Assign ADMIN group to all user profile with memberOf equals administrators</p></figcaption></figure>
