---
description: Overview of MFA Security.
---
...
<figure><img src="../../.gitbook/assets/graviteeio-am-userguide-mfa-ratelimit-exceed.png" alt=""><figcaption><p>Rate limit exceeded UI</p></figcaption></figure>
...
4.  Define your **Brute Force Detection** preferences.
    ...
    <figure><img src="../../.gitbook/assets/graviteeio-am-userguide-mfa-security.png" alt=""><figcaption><p>Brute force detection preferences</p></figcaption></figure>

Once the number of maximum attempts is reached, the user will be notified with an error message.

<figure><img src="../../.gitbook/assets/graviteeio-am-userguide-mfa-brute-max.png" alt=""><figcaption><p>Brute force error message</p></figcaption></figure>
