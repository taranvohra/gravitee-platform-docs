...
{% hint style="info" %}
The PAT Bearer Token which is used via the Authorization HTTP header must be obtained by the resource server via the [OAuth 2.0 client credentials flow](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/am/4.2/guides/auth-protocols/oauth-2.0).
...
You can use the [Introspection endpoint](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/am/4.2/guides/auth-protocols/oauth-2.0) to inspect the properties of the RPT.
