...
## Gravitee Access Management 4.11.12 - July 24, 2026
...
* Audit log for TOKEN\_REVOKED now correctly displays user profile name, when the user profile is disabled
