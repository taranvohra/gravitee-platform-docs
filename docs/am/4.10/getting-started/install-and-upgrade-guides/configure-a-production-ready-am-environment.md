...
### Step 1: Disable the internal APIs <a href="#step-1-disable-the-internal-apis" id="step-1-disable-the-internal-apis"></a>

AM API and AM Gateway include internal APIs which are enabled by default. If you do not intend to use them, we recommend you disable them.Perform the following steps on both the AM API component and the AM Gateway component:
...
### Step 2: Update the default users <a href="#step-2-update-the-default-users" id="step-2-update-the-default-users"></a>
...
<figure><img src="../../.gitbook/assets/gs-install-and-upgrade-guides-confi-18.png" alt="Admin password"><figcaption><p>Admin password</p></figcaption></figure>
