...
<figure><img src="../../../.gitbook/assets/guide-user-management-users-passwor-8.png" alt=""><figcaption><p>A user profile where Force Password Reset is set to true. This means that the user will be asked to update their password on the next login.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/guide-user-management-users-passwor-7.png" alt=""><figcaption><p>A user profile where Enable pre-registration is enabled. This means that the user will receive an email with a link that will allow the user to set their first password.</p></figcaption></figure>
