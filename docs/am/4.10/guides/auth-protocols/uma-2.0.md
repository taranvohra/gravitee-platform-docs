...
The resource owner must acquire a PAT to register a resource and create authorization grant rules. To obtain the PAT the resource owner must log in to the application using any [OAuth 2.0 flow](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/am/draft-4.10/guides/auth-protocols/oauth-2.0#flow).

In this example, we are using the [Resource owner password flow](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/docs/am/draft-4.10/guides/auth-protocols/oauth-2.0#flow):
