...
<figure><img src="../../.gitbook/assets/guides-identity-providers-user-and-role-2.png" alt=""><figcaption><p>Assign ADMIN group to all user profile with memberOf equals administrators</p></figcaption></figure>
