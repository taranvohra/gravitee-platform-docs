---
description: >-
  Sharding tags route APIs to particular API Gateway instances, and entrypoint
  mappings set what the Developer Portal shows. Follow the steps to manage both.
---
