---
description: >-
  What the Gamma 4.13 release adds across API Management, Event Stream
  Management, and the other modules. Browse the new features and changes.
---
...
* See [Review LLM Proxy deployment history](../agent-management/build/review-llm-proxy-deployment-history.md), [Review MCP Proxy deployment history](../agent-management/build/review-mcp-proxy-deployment-history/), and [Review A2A Proxy deployment history](../agent-management/build/review-a2a-proxy-deployment-history.md).
...
* See [Configure your API proxy](../api-management/build/configure-your-api-proxy/).
