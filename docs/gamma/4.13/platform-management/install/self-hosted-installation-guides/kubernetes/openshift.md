---
description: >-
  Install a fully self-hosted Gamma platform on OpenShift, with MongoDB and
  Elasticsearch. Follow the steps to deploy it with the Helm chart.
---
...
* **(Enterprise Edition only)** To enable Agent Management, you need an enterprise license that includes the `agent-management` pack. To get one, contact your Technical Account Manager. For more information, see [Add your license key](openshift.md#enterprise-edition-only-add-your-license-key).
...
1. [#create-the-project](openshift.md#create-the-project "mention")
2. [#deploy-mongodb-and-elasticsearch](openshift.md#deploy-mongodb-and-elasticsearch "mention")
3. [#enterprise-edition-only-add-your-license-key](openshift.md#enterprise-edition-only-add-your-license-key "mention")
4. [#prepare-the-values-yaml-for-helm](openshift.md#prepare-the-values-yaml-for-helm "mention")
5. [#install-the-gravitee-helm-chart](openshift.md#install-the-gravitee-helm-chart "mention")
