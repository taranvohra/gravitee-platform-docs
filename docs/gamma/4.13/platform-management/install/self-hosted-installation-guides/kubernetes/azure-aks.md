---
description: >-
  Run the full Gamma stack on Azure AKS behind an NGINX ingress controller.
  Follow the steps to create the namespace and install every component.
---
...
* **(Enterprise Edition only)** To enable Agent Management, you need an enterprise license that includes the `agent-management` pack. To get one, contact your Technical Account Manager. For more information, see [Add your license key](azure-aks.md#enterprise-edition-only-add-your-license-key).
...
1. [#create-the-namespace](azure-aks.md#create-the-namespace "mention")
2. [#deploy-mongodb-and-elasticsearch](azure-aks.md#deploy-mongodb-and-elasticsearch "mention")
3. [#enterprise-edition-only-add-your-license-key](azure-aks.md#enterprise-edition-only-add-your-license-key "mention")
4. [#prepare-the-values-yaml-for-helm](azure-aks.md#prepare-the-values-yaml-for-helm "mention")
5. [#install-with-helm](azure-aks.md#install-with-helm "mention")
