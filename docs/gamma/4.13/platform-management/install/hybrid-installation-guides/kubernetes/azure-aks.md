---
description: >-
  Install a hybrid Gamma Gateway on Azure AKS behind an NGINX ingress
  controller. Follow the steps to create the namespace and deploy the chart.
---
...
3. [#prepare-the-values-yaml-for-helm](azure-aks.md#prepare-the-values-yaml-for-helm "mention")
...
1. [#ensure-the-gateway-registers-in-gravitee-cloud](azure-aks.md#ensure-the-gateway-registers-in-gravitee-cloud "mention")
