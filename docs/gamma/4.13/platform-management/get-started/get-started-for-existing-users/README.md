---
description: >-
  Already running Gravitee? Activate Gamma on your existing installation instead
  of installing from scratch. Choose the path for how you run it.
---
...
* **Next-Gen Cloud:** Activate Gamma on a Gravitee Cloud account and connect a self-hosted Gateway. For more information, see the [hybrid installation guides](../../install/hybrid-installation-guides/).
