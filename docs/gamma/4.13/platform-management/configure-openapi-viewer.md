---
description: >-
  Choose which viewer the Gamma console and Developer Portal use to render
  OpenAPI specifications. Follow the steps to change the default viewer.
---
...
4. _(Optional)_ If using Redoc or Elements, you may configure additional rendering options specific to that viewer, such as theme colors or layout preferences.
5. Click **Save**.
