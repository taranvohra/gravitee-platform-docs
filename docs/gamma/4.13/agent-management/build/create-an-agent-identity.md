...
Select the persona card that matches how the agent runs—**Desktop Productivity Agent**, **Hosted Agent**, or **Workload Agent**. For more information, see [Agent personas](create-an-agent-identity.md#agent-personas). Select **Next**.
