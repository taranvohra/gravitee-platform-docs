---
description: >-
  Choose which API events send notifications for an LLM Proxy and where they are
  delivered. Follow the steps to add, edit, or delete a notification.
---

# Configure LLM Proxy notifications
