---
description: >-
  Create and configure the AI Gateway components that govern LLM, MCP, and A2A
  traffic, along with agent identities. Start with the proxy you need.
---
...
* [**Configure your MCP proxy**](configure-your-mcp/). Configure mediation, credential management, and the MCP Proxy's connection to upstream servers.
...
* [**Create an MCP Studio**](create-an-mcp-studio/). Compose tools, resources, prompts, and skills from multiple sources into a Composite MCP Server.
  * [**Edit tool composition**](create-an-mcp-studio/edit-mcp-studio-composition.md). Select and alias the tools exposed by your MCP Studio, and configure authentication to the upstream servers they come from.
...
* [**Configure your A2A Proxy**](configure-your-a2a-proxy/). Manage security, access controls, and flows for your A2A Proxy using the Policy Studio.
