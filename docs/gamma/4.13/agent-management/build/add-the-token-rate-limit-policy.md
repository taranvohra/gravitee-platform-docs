---
description: >-
  Add the Token Rate Limit policy to an LLM Proxy to cap the tokens a consumer
  spends over a rolling period. Follow the steps to configure it.
---
...
5. Configure the policy using the settings in [Settings](add-the-token-rate-limit-policy.md#settings).
6. Click **Save**.
