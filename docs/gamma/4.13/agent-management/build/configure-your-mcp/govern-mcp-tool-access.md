---
description: >-
  Authorization, rate limits, and response redaction govern what a caller can do
  through a Composite MCP Server. Learn how the three controls combine.
---
...
* [Create an MCP Studio](../create-an-mcp-studio/). Compose a Composite MCP Server and enable Fine-Grained Authorization.
