---
description: >-
  Add an AI model to the Catalog so authorization policies, observability, and
  cost attribution can reference it. Follow the steps to import one.
---
...
2. Select the model.
3. Update the **Display name** and **Description**. _Note: The Provider, Query name, Family, Context window, Capabilities, and Pricing are derived from the model source and cannot be changed._
4. Select **Save**.
