---
description: >-
  MCP resources are read-only data items agents use as context, discovered from
  registered MCP servers. Review the resources cataloged for your servers.
---
...
* **Compose into a Studio** — Include cataloged resources as context in a Composite MCP Server. See [Create an MCP Studio](../build/create-an-mcp-studio/).
