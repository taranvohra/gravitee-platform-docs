---
description: >-
  Prompts are reusable, parameterized templates discovered from registered MCP
  servers and cataloged for governance. Review your imported prompts.
---
...
* **Compose into a Studio** — Include cataloged prompts in a Composite MCP Server. See [Create an MCP Studio](../build/create-an-mcp-studio/).
