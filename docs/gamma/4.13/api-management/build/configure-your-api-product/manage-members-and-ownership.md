---
description: >-
  Add members, attach groups, change roles, and transfer ownership of an API
  product. Follow the steps to manage access from the User Permissions tab.
---
...
* [Configure API products](./). Review the other product configuration areas.
