---
description: >-
  Create or replace an API proxy by importing a Gravitee definition, an OpenAPI
  specification, or a WSDL document. Follow the steps to import a file.
---
...
7. Optional: for an OpenAPI specification or a WSDL, set the toggles in the **Options** section. See [Import options](import-an-api-proxy.md#import-options).
8. Click **Create API**.
...
8. Optional: for an OpenAPI specification or a WSDL, set the toggles in the **Options** section. See [Import options](import-an-api-proxy.md#import-options).
9. Click **Import**.
...
* [Configure your API proxy](configure-your-api-proxy/). Review endpoints, consumer access, and policies.
