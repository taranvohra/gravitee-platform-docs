---
description: >-
  Endpoint groups define where the API Gateway routes requests, with load
  balancing, timeouts, and TLS. Follow the steps to create a group and add
  endpoints.
---
...
6. Complete the wizard. For HTTP proxy APIs, a **Health-check** step follows the **General** and **Configuration** steps, with the same fields as the [endpoint health-check step](configure-backend-security.md#step-3-health-check).
