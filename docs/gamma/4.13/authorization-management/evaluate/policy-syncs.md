---
description: >-
  How authorization policies travel from the control plane to your runtime
  gateways, and how long it takes. Learn to read and monitor sync status.
---
...
* [Authorization policy synchronization](../configure/authz-gateway-sync.md) — Sync protocol reference
