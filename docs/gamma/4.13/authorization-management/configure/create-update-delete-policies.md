---
description: >-
  Reference for the Authorization Management policy editor, covering how to
  create, name, build, deploy, and delete a policy. Browse the full reference.
---
...
1. [Choose the policy category](create-update-delete-policies.md#choose-the-policy-category)
2. [Open the editor](create-update-delete-policies.md#open-the-editor)
3. [Name the policy](create-update-delete-policies.md#name-the-policy)
4. [Build statements](create-update-delete-policies.md#build-statements)
5. [Add conditions](create-update-delete-policies.md#add-conditions)
6. [Set target gateways](create-update-delete-policies.md#set-target-gateways)
7. [Save or deploy](create-update-delete-policies.md#save-or-deploy)
