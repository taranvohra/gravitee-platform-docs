---
description: >-
  Gamma continuously synchronizes policies and authorization data to every API
  Gateway that needs them. Learn what is synchronized, how a change becomes
  enforceable, and how engines are scoped.
---
