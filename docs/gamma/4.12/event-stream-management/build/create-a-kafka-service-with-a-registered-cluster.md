---
description: >-
  Create a Kafka Service bound to a connection on a registered Kafka cluster,
  with security plans and policies. Follow the steps in the creation wizard.
---
...
1. [Identity](create-a-kafka-service-with-a-registered-cluster.md#identity)
2. [Listener](create-a-kafka-service-with-a-registered-cluster.md#listener)
3. [Endpoint](create-a-kafka-service-with-a-registered-cluster.md#endpoint)
4. [Review and create](create-a-kafka-service-with-a-registered-cluster.md#review-and-create)
