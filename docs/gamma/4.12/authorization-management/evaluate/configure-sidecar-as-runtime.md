---
description: >-
  Deploy the Policy Decision Point as a sidecar beside your application for
  latency-sensitive or air-gapped environments. Follow the steps to deploy it.
---
...
* [Authorization policy synchronization](../configure/authz-gateway-sync.md) — Sync protocol details
