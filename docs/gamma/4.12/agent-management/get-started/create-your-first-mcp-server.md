---
description: >-
  Create your first MCP Proxy in front of an upstream MCP server, using Proxy
  mode with API key security. Follow the quickstart to get it running.
---
...
1. [Open the MCP Proxy wizard](create-your-first-mcp-server.md#open-the-mcp-proxy-wizard).
2. [Configure security](create-your-first-mcp-server.md#configure-security).
3. [Connect to the upstream server](create-your-first-mcp-server.md#connect-to-the-upstream-server).
4. [Review and create](create-your-first-mcp-server.md#review-and-create).
...
* **Configure mediation.** Establish token exchange and credential mediation for upstream MCP servers that require their own OAuth. See [Configure your MCP proxy](../build/configure-your-mcp/).
* **Create a Composite MCP Server.** Compose tools from multiple upstream servers, APIs, and events into a single governed MCP server. See [Create an MCP Studio](../build/create-an-mcp-studio/).
