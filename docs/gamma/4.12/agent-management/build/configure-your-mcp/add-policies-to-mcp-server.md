...
For SCIM connector configuration, users and groups synced through SCIM are managed by the connector—they can't be deleted individually, and removing the connector removes the synced entities and their associated policies.
