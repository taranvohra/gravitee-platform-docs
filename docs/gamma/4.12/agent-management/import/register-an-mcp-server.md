---
description: >-
  Register an MCP server to add it to the Catalog with its tools, resources, and
  prompts. Follow the steps to verify the URL and import its capabilities.
---
...
* **Compose into a Studio** — Include this server's tools in a Composite MCP Server. See [Create an MCP Studio](../build/create-an-mcp-studio/).
