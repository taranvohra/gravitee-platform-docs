---
description: >-
  Expose REST APIs governed in API Management as agent-accessible tools in the
  Catalog. Follow the steps to create an API tool from your endpoints.
---
...
* **Compose into a Studio**. Include API tools in a Composite MCP Server alongside MCP-native tools. See [Create an MCP Studio](../build/create-an-mcp-studio/).
