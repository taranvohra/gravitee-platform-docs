---
description: >-
  Add a knowledge source so agents can read documentation and reference material
  as context. Follow the steps to add inline or remote documents.
---
...
* **Compose into a Studio** — Include knowledge sources as context in a Composite MCP Server. See [Create an MCP Studio](../build/create-an-mcp-studio/).
