---
description: >-
  Create a keyless API proxy in the Gamma console, deploy it to the API Gateway,
  and verify it with a test request. Follow the quickstart to build one.
---
...
* **Configure advanced settings** — Add CORS rules, sharding tags, and entrypoint customization. See [Configure your API proxy](../build/configure-your-api-proxy/).
