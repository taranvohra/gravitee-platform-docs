---
description: >-
  Create an API product, attach APIs, add and publish plans, and deploy it over
  the v2 Management API. Follow the full lifecycle with request examples.
---
...
* [Configure API products](./). Plans, consumers, and permissions for a product.
