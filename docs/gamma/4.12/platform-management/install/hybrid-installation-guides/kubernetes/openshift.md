---
description: >-
  Install a hybrid Gamma Gateway on OpenShift, from creating the project to
  running Redis. Follow the steps to deploy it with the Helm chart.
---
...
2. [#install-redis](openshift.md#install-redis "mention")
3. [#prepare-the-values-yaml-for-helm](openshift.md#prepare-the-values-yaml-for-helm "mention")
4. [#install-the-gravitee-helm-chart](openshift.md#install-the-gravitee-helm-chart "mention")
...
1. [#ensure-the-gateway-registers-in-gravitee-cloud](openshift.md#ensure-the-gateway-registers-in-gravitee-cloud "mention")
2. [#validate-the-pods](openshift.md#validate-the-pods "mention")
3. [#validate-the-gateway-url](openshift.md#validate-the-gateway-url "mention")
