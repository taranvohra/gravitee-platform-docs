---
description: >-
  Define a hybrid Gamma Gateway in a compose file and an env file, then bring it
  up in one command. Follow the steps to write and run them.
---
...
2. [#create-the-env-file](docker-compose.md#create-the-env-file "mention")
3. [#start-the-gateway](docker-compose.md#start-the-gateway "mention")
...
1. [#ensure-the-gateway-registers-in-gravitee-cloud](docker-compose.md#ensure-the-gateway-registers-in-gravitee-cloud "mention")
2. [#ensure-the-gateway-is-listening-locally](docker-compose.md#ensure-the-gateway-is-listening-locally "mention")
