---
description: >-
  New to Gravitee and want to run Gamma? Choose between Gravitee Next-Gen Cloud
  and installing it yourself. Compare the two paths and pick one.
---
...
* **Next-Gen Cloud:** Gravitee hosts the Gamma control plane, and you connect your own self-hosted Gateway. To create an account, go to [Gravitee Cloud](https://cloud.gravitee.io). To connect your Gateway, see the [hybrid installation guides](../../install/hybrid-installation-guides/).
