...
{% hint style="info" %}
This capability is available on **AWS only** and is set up **on demand**: it is configured manually for your account rather than self-service. To enable it, [contact Gravitee](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/gravitee-cloud/community-and-support/enterprise-support/README.md).
{% endhint %}
...
Setup requires manual configuration on both Gravitee's side and within your AWS environment. To begin, [contact Gravitee](https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/gravitee-cloud/community-and-support/enterprise-support/README.md). The team aligns with you on your requirements, such as region and network details, and then completes the setup.

## Next steps

The following resources provide additional context:

<table data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td>Establish private networks with GCP</td><td><a href="https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/gravitee-cloud/guides/establish-private-networks-with-gcp/README.md">https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/gravitee-cloud/guides/establish-private-networks-with-gcp/README.md</a></td></tr><tr><td>Gravitee Cloud Geography and Provider Support</td><td><a href="https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/gravitee-cloud/reference/geography-and-provider-support/README.md">https://github.com/taranvohra/gravitee-platform-docs/tree/docs-site/gravitee-cloud/reference/geography-and-provider-support/README.md</a></td></tr></tbody></table>
